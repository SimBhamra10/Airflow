...
@dag(
    dag_id="scheduler_preset_catchup_dag",
    start_date=datetime(year=2026, month=5, day=1, tz="Asia/Kolkata"),
    schedule=CronTriggerTimetable('0 5 10 * MON-FRI', timezone="Asia/Kolkata"),
    end_date=datetime(year=2026, month=5, day=31, tz="Asia/Kolkata"),
    is_paused_upon_creation=False,
    catchup=True

)
def scheduler_preset_catchup_dag():
